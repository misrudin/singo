...
<div class="back-action mt-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9">
                <a class="back-button" href="{{ url('/'.$name.'/publikasi') }}">
                    <img src="{{asset('front/assets/icons/left.png')}}" alt="Back"> Publikasi {{ucfirst($name)}}
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="row_detail_publikasi">
                    <div class="detail-publikasi">
                        ...
                        <div class="item-detail-publikasi mt-3">
                            ...
                            <img class="icon-publikasi ms-4" src="{{asset('front/assets/icons/feather_globe.svg')}}"
                                 alt="Calwndar">
                        ...
                        <div class="item-detail-publikasi mt-2">
                            <img class="icon-publikasi" src="{{asset('front/assets/icons/feather_bookmark.svg')}}"
                                 alt="Calwndar">
                    ...
                    <div class="detail-publikasi-description">
                        ...
                        <p class="description-publikasi mt-2">Integer eget aliquet nibh praesent. Porttitor eget dolor
                            morbi non arcu risus quis. Viverra
